...
conf.registerChannelValue(Encyclopedia, 'database',
    registry.String('ubnot2', 'Name of database to use'))

conf.registerChannelValue(Encyclopedia, 'relaychannel',
    registry.String('##gavchat', 'Relay channel for unauthorized edits'))

conf.registerGlobalValue(Encyclopedia, 'editchannel',
        registry.SpaceSeparatedListOfStrings(['##gavchat'], 
